  ...
  return (
    <div style={{
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{
          ...
          <div style={{display: 'flex', alignItems: 'start', gap: '12px', marginBottom: '15px'}}>
            ...
            <label style={{color: '#f59e0b', lineHeight: '1.6', fontSize: '0.95rem'}}>
              <strong>⚠️ AI Analysis Disclaimer:</strong> I understand that this analysis uses AI algorithms and is provided for informational purposes only. Results should not be considered as professional advice or replace laboratory testing. AuditDNA is not liable for decisions made based on these results. *
            </label>
          </div>
        ...
        >
          ✅ Save Contact Information & Continue
        </button>
      </form>
    </div>
  );

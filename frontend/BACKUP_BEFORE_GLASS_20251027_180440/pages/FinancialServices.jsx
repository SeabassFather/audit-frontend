...
export default function FinancialServices() {
  ...
  const tabs = [
    { id: 'factoring', label: 'Invoice Factoring', icon: '💵' },
    { id: 'payment-terms', label: 'Payment Terms', icon: '📅' },
    { id: 'credit-risk', label: 'Credit Risk', icon: '⚠️' },
...
function ReportsTab() {
  const reports = [
    { name: 'Summary Report', icon: '📊', desc: 'Key financial metrics and KPIs', color: '#3b82f6' },
    { name: 'AR Aging Report', icon: '📅', desc: 'Accounts receivable aging analysis', color: '#22c55e' },
    { name: 'Profitability Analysis', icon: '💰', desc: 'Product-level profit margins', color: '#8b5cf6' },
    { name: 'Cash Flow Statement', icon: '💵', desc: 'Operating, investing, financing activities', color: '#eab308' }
  ];

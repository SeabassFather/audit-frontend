...
const text = {
  ...
  spanish: {
    ...
    alertText: "Todos los campos son obligatorios. Debe completar este registro antes de poder subir propiedades a la plataforma. Su información será verificada antes de la aprobación.",
    formTitle: "Formulario de Calificación de Agente",
    formSubtitle: "Por favor proporcione información precisa",
    ...
    questions: "¿Preguntas sobre el registro?",
    contact: "Contacto: support@auditdna.com",
    required: "es requerido",
    invalidEmail: "El correo electrónico no es válido",
    invalidPhone: "El número de teléfono no es válido",
    // Refi
    refiTitle: "Refinanciamiento / Compra en México (Solo Ciudadanos USA)",
    refiSubtitle: "Exclusivo para ciudadanos estadounidenses que buscan refinanciar o comprar casa en México. Préstamo mínimo: $385,000 USD. Anticipo requerido: 35-45%. Aplican otras restricciones.",
    propertyType: "Tipo de Propiedad",
    address: "Dirección de la Propiedad en México",
    downPayment: "Anticipo (%)",
    loanAmount: "Monto de Préstamo Deseado (USD)",
    notes: "Notas Adicionales / Preguntas",
    refiSubmit: "Enviar Solicitud de Crédito/Refinanciamiento",
    refiThankyou: "¡Gracias! Nuestro equipo de crédito se comunicará para los siguientes pasos.",
    invalidLoan: "El monto mínimo de préstamo es $385,000 USD",
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div>
            ...
            <input
              ...
              placeholder={language === "english" ? "John Doe" : "Juan Pérez"}
          ...
          <div>
            ...
            <input
              ...
              value={form.address}
              onChange={handleChange}
              placeholder={language === "english" ? "Mexico, Address" : "Dirección en México"}
          ...
          <div>
            ...
            <textarea
              ...
              value={form.notes}
              onChange={handleChange}
              placeholder={language === "english" ? "Tell us more about your needs..." : "Cuéntenos más sobre sus necesidades..."}

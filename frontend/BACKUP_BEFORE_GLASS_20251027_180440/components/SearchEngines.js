...
export default function SearchEngines({ activeSearchEngine, setActiveSearchEngine }) {
  ...
  const engines = [
    ...
    { id: 'watertech', en: 'WaterTech', es: 'Análisis de Agua', icon: FileText, color: '#2196f3' },
    { id: 'mortgage', en: 'Mortgage', es: 'Hipotecas', icon: Home, color: '#ff9800' },
    { id: 'factoring', en: 'Ag Factoring', es: 'Factoraje Agrícola', icon: DollarSign, color: '#9c27b0' },
    { id: 'mexico', en: 'Mexico RE', es: 'Bienes Raíces MX', icon: Briefcase, color: '#f44336' },

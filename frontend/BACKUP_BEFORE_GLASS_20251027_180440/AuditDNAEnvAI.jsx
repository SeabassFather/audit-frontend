      ...
      {step === 2 && (
        <div style={{background: '#1e293b', padding: '30px', borderRadius: '16px'}}>
          ...
          <div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px'}}>
            ...
            <div>
              <label style={{display: 'block', marginBottom: '8px', color: '#94a3b8'}}>Temperature (°C)</label>
      ...
      {step === 5 && (
        <div>
          ...
          <div style={{background: '#1e293b', padding: '30px', borderRadius: '16px', marginTop: '30px', textAlign: 'center'}}>
            <h2 style={{color: '#10b981', marginBottom: '20px'}}>✅ Analysis Complete!</h2>

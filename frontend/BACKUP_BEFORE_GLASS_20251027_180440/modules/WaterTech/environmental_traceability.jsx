...
const tabs = [
  { id: "water", label: "WaterTech", icon: "💧" },
  { id: "soil", label: "Soil Science", icon: "🌱" },
  { id: "fertilizer", label: "Fertilizer Audit", icon: "🧪" },
  { id: "environment", label: "Environmental Monitor", icon: "🌍" },
  { id: "certifications", label: "Certifications", icon: "📜" },
  { id: "traceability", label: "Traceability Map", icon: "🗺️" },
];
  ...
  return (
    <div className="dashboard-bg">
      <header className="dashboard-header">
        ...
        <h2>
          Futuristic Environmental & Agricultural Traceability · Real-Time AI Analysis · Blockchain-Ready Compliance
        </h2>
      </header>
  ...
  return (
    <section>
      ...
      <ul className="dashboard-feature-list">
        ...
        <li>Eco Sustainability Index (0–100) & AI risk flagging</li>
      </ul>
      <div className="dashboard-actions">
        <button className="dashboard-btn dashboard-btn-primary" onClick={onFetch}>

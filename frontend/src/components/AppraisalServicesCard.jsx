...
<<<<<<< HEAD
    ...
    thankyou: "¡Gracias! Nuestro equipo de avalúos le contactará con los siguientes pasos."
=======
    title: "Solicitar Servicios de AvalÃƒÂºo",
    subtitle: "Solicite un avalÃƒÂºo certificado para propiedad en MÃƒÂ©xico o EE.UU.",
    fullName: "Nombre Completo",
    email: "Correo ElectrÃƒÂ³nico",
    phone: "NÃƒÂºmero de TelÃƒÂ©fono",
    propertyAddress: "Domicilio de la Propiedad",
    propertyType: "Tipo de Propiedad",
    purpose: "PropÃƒÂ³sito del AvalÃƒÂºo",
    notes: "Notas / Preguntas Adicionales",
    uploadPhotos: "Subir Fotos (opcional)",
    uploadDocs: "Subir Documentos Legales (opcional)",
    submit: "Solicitar AvalÃƒÂºo",
    thankyou: "Ã‚Â¡Gracias! Nuestro equipo de avalÃƒÂºos le contactarÃƒÂ¡ con los siguientes pasos."
>>>>>>> my/push-branch
  }
};
...
<<<<<<< HEAD
  {en: "Estate Planning", es: "Planificación Patrimonial"},
=======
  {en: "Estate Planning", es: "PlanificaciÃƒÂ³n Patrimonial"},
>>>>>>> my/push-branch
      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div>
            ...
            >
<<<<<<< HEAD
              <option value="">{language === "english" ? "Select purpose" : "Seleccione propósito"}</option>
=======
              <option value="">{language === "english" ? "Select purpose" : "Seleccione propÃƒÂ³sito"}</option>
>>>>>>> my/push-branch

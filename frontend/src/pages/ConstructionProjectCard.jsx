...
const text = {
  ...
  spanish: {
<<<<<<< HEAD
    title: "Financiamiento de Proyecto de Construcción (Ciudadanos EE.UU.)",
    subtitle: "Financie su proyecto de construcción en México (Colateral en EE.UU. aceptado)",
    fullName: "Nombre Completo",
    email: "Correo Electrónico",
    phone: "Número de Teléfono",
    projectAddress: "Dirección del Proyecto en México",
    projectType: "Tipo de Proyecto",
    projectCost: "Costo Estimado del Proyecto (USD)",
    landOwned: "¿Es dueño del terreno?",
=======
...
<<<<<<< HEAD
    ...
    thankyou: "¡Gracias! Nuestro equipo de financiamiento se comunicará."
=======
...
<<<<<<< HEAD
              <option value="yes">{language === "english" ? "Yes" : "Sí"}</option>
=======

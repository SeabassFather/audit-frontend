...
<<<<<<< HEAD
          <h1 className="text-4xl font-bold mb-2">🔍 Real-Time Certification Verification</h1>
          <p className="text-green-100">5 databases • 733,000+ records • Full intel & sharing</p>
=======
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
<<<<<<< HEAD
                        <h3 className="text-2xl font-bold text-green-800">✓ VERIFIED & CERTIFIED</h3>
=======
...
<<<<<<< HEAD
                          📍 Coordinates: {searchResults.latitude}, {searchResults.longitude}
=======
...
<<<<<<< HEAD
                          <span className="font-bold">📍 Verified Location: {searchResults.city}, {searchResults.state}</span>
=======
...
<<<<<<< HEAD
                    ...
                    <p className="text-sm text-orange-800 font-semibold mb-4">
                      ⚡ Direct contacts to purchasing team - bypass gatekeepers!
=======
...
<<<<<<< HEAD
                      ⚡ Similar suppliers in the same area - expand your options!
=======
...
<<<<<<< HEAD
                              <div className="text-xs text-gray-600 mb-1">📍 {lead.distance}</div>
=======
...
<<<<<<< HEAD
                            <div className="text-xs text-gray-600 mb-1">💼 Buyer Contact</div>
...
<<<<<<< HEAD
                      <p className="font-bold mb-2">💡 WHY CROSS-REFERENCE?</p>
=======
...
<<<<<<< HEAD
                    <p className="text-sm text-red-600 mt-2">⚠️ DO NOT PROCEED - Supplier cannot be verified as legal</p>
=======

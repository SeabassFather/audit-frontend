  ...
  return (
    <div style={{padding: '40px', background: '#0f172a', minHeight: '100vh', color: 'white'}}>
      <h1 style={{fontSize: '2.5rem', color: '#06b6d4', marginBottom: '30px'}}>
        Ã°Å¸â€™Â§ {language === 'es' ? 'AnÃƒÂ¡lisis de Calidad del Agua' : 'Water Quality Analysis'}
      </h1>
      ...
      <div style={{
        ...
        {[
          {num: 1, label: language === 'es' ? 'Contacto' : 'Contact', icon: 'Ã°Å¸â€œâ€¹'},
          {num: 2, label: language === 'es' ? 'Pruebas' : 'Tests', icon: 'Ã°Å¸â€Â¬'},
          {num: 3, label: language === 'es' ? 'UbicaciÃƒÂ³n' : 'Location', icon: 'Ã°Å¸â€œÂ'},
          {num: 4, label: language === 'es' ? 'Condiciones' : 'Conditions', icon: 'Ã°Å¸Å’Â¡Ã¯Â¸Â'},
          {num: 5, label: language === 'es' ? 'Cargar' : 'Upload', icon: 'Ã°Å¸â€œÂ¤'},
          {num: 6, label: language === 'es' ? 'Pago' : 'Payment', icon: 'Ã°Å¸â€™Â³'},
          {num: 7, label: language === 'es' ? 'QR' : 'QR Code', icon: 'Ã°Å¸â€œÂ±'}
        ].map(s => (
          <div key={s.num} style={{
            textAlign: 'center',
      ...
      {step === 2 && (
        <>
          ...
          <button
            onClick={() => {
              if (selectedTests.length === 0) {
                alert(language === 'es' ? 'Ã¢Å¡Â Ã¯Â¸Â Seleccione al menos una prueba!' : 'Ã¢Å¡Â Ã¯Â¸Â Please select at least one test!');
                return;
              }
              setStep(3);
            }}
          ...
          >
            {language === 'es' ? 'Ã¢Å“â€¦ Continuar a UbicaciÃƒÂ³n' : 'Ã¢Å“â€¦ Continue to Location'}
          </button>
        </>
      )}
        ...
        <div>
          ...
          <div style={{
            ...
            <h2 style={{color: '#10b981', marginBottom: '20px'}}>
              Ã¢Å“â€¦ {language === 'es' ? 'Ã‚Â¡AnÃƒÂ¡lisis Completo!' : 'Analysis Complete!'}
            </h2>
            <div style={{fontSize: '4rem', marginBottom: '15px'}}>Ã°Å¸â€™Â§</div>
            ...
            >
              Ã°Å¸â€œâ€ž {language === 'es' ? 'Descargar Reporte' : 'Download Report'}
            </button>
            <button 
              onClick={() => {
                setStep(1); 
            ...
            >
              Ã°Å¸â€â€ž {language === 'es' ? 'Nuevo AnÃƒÂ¡lisis' : 'New Analysis'}
            </button>
          </div>
        </div>
      )}

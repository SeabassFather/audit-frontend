      ...
      <section className="bg-white rounded-xl shadow-md border border-gray-100 mb-8 p-8">
        ...
        <form className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row md:gap-10">
              <div className="space-y-2 flex-1">
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="accent-blue-600" />I consent
                  to OCR and AI analysis.
                </label>
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="accent-blue-600" />I
                  authorize regulatory transmission (CFPB, State).
                </label>
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="accent-blue-600" />I
                  understand QR verification will be attached.
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 pt-2">
            <a
              href="/download/authorization.txt"
            ...
            <button
              type="submit"
              className="ml-auto px-5 py-2 bg-blue-700 text-white rounded-md shadow hover:bg-blue-800 transition"
            >
              Submit
            </button>
          </div>
        ...
        <form className="space-y-4">
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
              ...
              <label className="flex items-center gap-2">
                <input type="checkbox" className="accent-green-600" /> Escrow
                Officer
              </label>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
            ...
            <div className="flex gap-4 items-center">
              <label className="flex items-center gap-2">
                <input type="checkbox" className="accent-green-600" /> I affirm
                eligibility
              </label>
              <label className="flex items-center gap-2">
                <input type="checkbox" className="accent-green-600" /> I agree
                to policies
              </label>
            </div>
            <div className="flex gap-2 items-center">
              ...
              <input
                type="text"
                className="w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 ml-2"
                placeholder="Type full name"
              />
              <label className="block text-gray-700 ml-3">Date</label>
              <input
                type="date"
                className="border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 ml-2"
              />
            </div>
          </div>
          <div className="flex items-center gap-4 pt-2">
            <a
              href="/download/partner-eligibility.txt"
            ...
            <button
              type="submit"
              className="ml-auto px-5 py-2 bg-green-700 text-white rounded-md shadow hover:bg-green-800 transition"
            >
              Submit
            </button>
          </div>

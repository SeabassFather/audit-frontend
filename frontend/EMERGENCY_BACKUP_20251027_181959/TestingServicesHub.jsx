  ...
  return (
    <div style={{padding: '40px', background: '#0f172a', minHeight: '100vh', color: 'white'}}>
      <h1 style={{fontSize: '2.5rem', color: '#3b82f6', marginBottom: '30px'}}>
        Ã°Å¸â€Â¬ Professional Testing Services
      </h1>
      ...
      <div style={{
        ...
        {[
          ...
          {num: 2, label: 'Select Tests', icon: 'Ã°Å¸â€Â¬'},
          {num: 3, label: 'Upload Samples', icon: 'Ã°Å¸â€œÂ¤'},
      ...
      {step === 2 && (
        <div>
          <div style={{
            ...
            <h2 style={{color: '#3b82f6', marginBottom: '10px'}}>Ã°Å¸Ââ€  ISO 17025 Certified Testing</h2>
            ...
            {testPackages.map(test => (
              ...
              >
                ...
                <div style={{display: 'flex', gap: '15px', marginBottom: '15px', fontSize: '0.9rem'}}>
                  <span style={{color: '#64748b'}}>Ã¢ÂÂ±Ã¯Â¸Â {test.turnaround}</span>
                  <span style={{color: '#64748b'}}>Ã°Å¸Â§Âª {test.tests.length} Tests</span>
                </div>
                ...
                <div style={{
                  ...
                  {selectedTests.includes(test.id) ? 'Ã¢Å“â€œ Selected' : 'Click to Select'}
                </div>
              </div>
            ))}
          </div>
          ...
          >
            {loading ? 'Ã¢ÂÂ³ Processing...' : `Ã°Å¸â€Â¬ Order ${selectedTests.length} Test${selectedTests.length !== 1 ? 's' : ''} - $${calculateTotal()}`}
          </button>
        </div>
      )}
      ...
      {step === 5 && (
        <div>
          ...
          <div style={{background: '#1e293b', padding: '30px', borderRadius: '16px', marginTop: '30px', textAlign: 'center'}}>
            <h2 style={{color: '#10b981', marginBottom: '20px'}}>Ã¢Å“â€¦ Order Confirmed!</h2>
            ...
            <p style={{color: '#64748b', fontSize: '0.95rem', lineHeight: '1.6'}}>
              Ã°Å¸â€œÂ§ Sample collection kit and shipping instructions have been emailed to {contactInfo?.email}
            </p>
          </div>
        </div>
      )}

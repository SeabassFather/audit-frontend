...
export default function QRCodeComponent({ 
  ...
  return (
    <div style={{
      ...
      <div style={{fontSize: '3rem', marginBottom: '15px'}}>Ã°Å¸â€œÂ±</div>
      ...
      <div style={{
        ...
        <p style={{color: '#06b6d4', margin: 0, lineHeight: '1.6'}}>
          Ã°Å¸â€œÂ± <strong>Scan this QR code</strong> to track your order status, view results, and download reports. 

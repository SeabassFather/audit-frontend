    ...
    <div style={{background: '#1e293b', padding: '30px', borderRadius: '16px', marginBottom: '30px'}}>
      ...
      <div style={{marginBottom: '25px'}}>
        <h2 style={{color: color, fontSize: '1.5rem', marginBottom: '10px'}}>
          ðŸ”¬ Test Catalog ({testCatalog.length} Available)
        </h2>
      ...
      <div style={{
        ...
        <div style={{position: 'relative'}}>
          <input
            type="text"
            placeholder="ðŸ” Search tests by name, parameter, or keyword..."
            value={searchTerm}
        ...
        >
          <option value="name">ðŸ”¤ Sort: A-Z</option>
          <option value="price">ðŸ’° Sort: Price</option>
          <option value="popular">â­ Sort: Popular</option>
        </select>
      </div>
          ...
          <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px'}}>
            <div>
              <span style={{color: color, fontWeight: '700', fontSize: '1.1rem'}}>
                âœ“ {selectedTests.length} Test{selectedTests.length !== 1 ? 's' : ''} Selected
              </span>
            </div>

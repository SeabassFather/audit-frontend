  ...
  return (
    <div className="water-tech-module">
      <div className="module-hero">
        <h1>ðŸ’§ Water Technology & Quality Management</h1>
        ...
        <div className="input-panel">
          <form onSubmit={handleSubmit}>
            <div className="form-section">
              <h2>ðŸ”¬ Water Quality Parameters</h2>
              ...
              <div className="input-group">
                ...
                <div className="impact-note">
                  ðŸ’¡ Maintaining 6.0-7.0 improves nutrient uptake by 15-20%
                </div>
              </div>
              ...
              <div className="input-group">
                ...
                />
                <div className="impact-note">
                  ðŸ’° Lower nitrate = 10-25% reduction in fertilizer cost
                </div>
              </div>
              ...
              <div className="input-group">
                ...
                />
                <div className="impact-note">
                  ðŸ”§ Protects drip systems, prevents clogging
                </div>
              </div>
              ...
              <div className="input-group">
                ...
                <div className="impact-note">
                  ðŸ“‹ Determines treatment requirements and traceability
                </div>
              </div>
            ...
            <button type="submit" className="analyze-btn" disabled={loading}>
              {loading ? "â³ Analyzing..." : "ðŸš€ Analyze Water Quality & Calculate ROI"}
            </button>
          </form>
        </div>
        ...
        {analysis && (
          <div className="analysis-panel">
            <div className="roi-dashboard">
              <h2>ðŸ’° Economic Impact Analysis</h2>
              ...
              <div className="roi-breakdown">
                ...
                <div className="roi-item">
                  <span className="roi-icon">âœ…</span>
                  <div className="roi-details">
                ...
                <div className="roi-item">
                  <span className="roi-icon">ðŸŒ¾</span>
                  <div className="roi-details">
            ...
            <div className="compliance-card">
              <h3>ðŸ“‹ Regulatory Compliance Status</h3>
              <div className="compliance-grid">
                {Object.entries(analysis.compliance).map(([agency, status]) => (
                  <div key={agency} className={`compliance-item ${status ? 'compliant' : 'warning'}`}>
                    <span className="status-icon">{status ? 'âœ…' : 'âš ï¸'}</span>
                    <div>
            ...
            <div className="certification-card">
              <h3>ðŸ† Certification Eligibility</h3>
            ...
            <div className="export-actions">
              <button className="export-btn">ðŸ“¥ Export Report (PDF)</button>
              <button className="export-btn">ðŸ“Š Send to USDA Dashboard</button>
              <button className="export-btn">ðŸ”— Link to Blockchain</button>
            </div>
          </div>
        )}
      </div>

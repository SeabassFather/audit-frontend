    ...
    <div style={{
      ...
      <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px'}}>
        <h3 style={{color: '#06b6d4', fontSize: '1.3rem', margin: 0}}>
          ðŸ“¤ Upload Lab Reports & Documents
        </h3>
      ...
      >
        {uploading ? 'â³ Uploading...' : `ðŸ“¤ Upload ${files.length} File${files.length !== 1 ? 's' : ''}`}
      </button>
      ...
      <p style={{
        ...
        ðŸ’¡ <strong>Tip:</strong> Upload lab reports, test results, photos, or any supporting documentation. 

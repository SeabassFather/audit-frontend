...
export default function Megadashboard() {
  ...
  const modules = [
    { name: 'Financial Services', icon: 'Ã°Å¸â€™Â°', path: '/financial', desc: 'Click to Access Ã¢â€ â€™', border: '#3b82f6', bg: '#23293a', color: '#fff' },
    { name: 'Real Estate', icon: 'Ã°Å¸ÂÂ ', path: '/real-estate', desc: 'Click to Access Ã¢â€ â€™', border: '#22c55e', bg: '#23293a', color: '#fff' },
    { name: 'Agriculture', icon: 'Ã°Å¸Å’Â½', path: '/agriculture', desc: 'Click to Access Ã¢â€ â€™', border: '#eab308', bg: '#23293a', color: '#fff' },
    { name: 'Compliance', icon: 'Ã¢Å“â€¦', path: '/compliance', desc: 'Click to Access Ã¢â€ â€™', border: '#64748b', bg: '#23293a', color: '#fff' },
    { name: 'Analytics', icon: <img alt="analytics" src="https://img.icons8.com/fluency/48/000000/combo-chart.png" style={{height:"2rem"}} />, path: '/analytics', desc: 'Click to Access Ã¢â€ â€™', border: '#3b82f6', bg: '#23293a', color: '#fff' },
    { name: 'Mexico Ops', icon: 'MX', path: '/mexico', desc: 'Click to Access Ã¢â€ â€™', border: '#22c55e', bg: '#23293a', color: '#fff' },
  ];

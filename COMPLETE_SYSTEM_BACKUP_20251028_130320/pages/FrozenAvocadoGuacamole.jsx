      ...
      <div className="bg-gradient-to-r from-green-700 via-emerald-600 to-green-700 rounded-xl p-8 text-white">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-green-100 text-lg">Market intelligence Ã¢â‚¬Â¢ Pricing Ã¢â‚¬Â¢ Suppliers Ã¢â‚¬Â¢ Buyers</p>
          </div>
        </div>
      </div>
              ...
              {suppliers.map((supplier, idx) => (
                <div key={idx} className="border-2 border-gray-200 rounded-lg p-4">
                  ...
                  <div className="text-sm text-gray-600">
                    {supplier.location} Ã¢â‚¬Â¢ {supplier.volume}
                  </div>
                </div>
              ))}
            </div>

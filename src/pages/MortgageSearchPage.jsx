...
export default function MortgageSearchPage(){
 ...
 <div className="font-medium">{r.lender} ÃƒÂ¢Ã¢â€šÂ¬" {r.product} ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ {r.rate}</div>
 <div className="text-xs text-slate-600">Fit: {r.fit} Ãƒâ€šÃ‚Â· {r.reasons.join(", ")}</div>
 </li>
 ))}
 </ul>
 </div>

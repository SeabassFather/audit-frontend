...
const text = {
  ...
  spanish: {
    ...
    subtitle: "Use este formulario para preguntar, agendar una visita o solicitar más información sobre una propiedad.",
    name: "Su Nombre",
    email: "Su Correo",
    ...
    thankyou: "¡Gracias! El propietario le contactará pronto."
  }
};

...
function buildNassUrl({commodity_desc, statisticcat_desc, unit_desc}, year) {
  ...
  return `https://quickstats.nass.usda.gov/api/api_GET/?key=${USDA_API_KEY}` +
          ...
          return (
            <div key={c.name} style={{
              ...
              <div style={{ fontSize: ".97rem", color: "#222" }}>
                <span style={{ fontWeight: 600 }}>High:</span> ${d.high?.toFixed(2) || "-"}
              </div>
              <div style={{ fontSize: ".97rem", color: "#222" }}>
                <span style={{ fontWeight: 600 }}>Low:</span> ${d.low?.toFixed(2) || "-"}
              </div>
              <div style={{ fontSize: ".97rem", color: "#222" }}>
                <span style={{ fontWeight: 600 }}>Avg:</span> ${d.avg?.toFixed(2) || "-"}
              </div>
            </div>
          );
        })}

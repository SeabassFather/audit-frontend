// Minimal metadata + per-service dynamic forms.
// Each form field: { name, label, type, required?, options? }
...
// Default description + default generic form (used when a service has no explicit entry above)

        ...
        <div className="p-5 space-y-5 overflow-y-auto h-[calc(100%-64px)]">
          ...
          <div>
            ...
            <div className="mt-3 flex gap-2">
              <button className="px-3 py-2 rounded-lg bg-gray-200 hover:bg-gray-300 flex items-center gap-2">
                <Download size={16} /> Download Pack (stub)
              </button>
              <button className="px-3 py-2 rounded-lg border hover:bg-gray-50 flex items-center gap-2">
                <BookOpen size={16} /> View Agreement (stub)
              </button>
            </div>
          </div>
          <div className="pt-2">
            <button
              onClick={() => onStart(slug, service)}
              className="w-full px-4 py-3 rounded-xl bg-green-600 text-white font-semibold hover:brightness-95 flex items-center justify-center gap-2"
            >
              <CheckCircle2 size={18} /> Start {service}
            </button>
          </div>
          <div className="text-xs text-gray-400">
            You can customize fields, forms, and routing per service later in
            Admin.
          </div>
        </div>
      </div>

  ...
  return (
    <>
      <form onSubmit={submit} className="card">
        ...
        <input
          className="filter"
          placeholder="LA Warehouse Partner (optional)"
          value={f.warehouse}
        ...
        <label className="subtext">
          <input
            type="checkbox"
            checked={f.recallPlan}
            onChange={set("recallPlan")}
          />{" "}
          Recall plan on file
        </label>
        ...
        <input
          className="filter"
          placeholder="Volume/week or month"
          value={f.volume}
          onChange={set("volume")}
        />
        <input
        ...
        <input
          className="filter"
          placeholder="Buyer type (retail/wholesale/chain)"
          value={f.buyerType}
        ...
        <button className="btn" type="submit">
          Search Growers / Compliance
        </button>
      </form>

      <div className="grid" style={{ marginTop: 12 }}>
        <FileUpload
          label="Upload Certifications (PDF/IMG)"
          accept=".pdf,.png,.jpg"
          endpoint={endpoints.uploadWater()}
        />
        <FileUpload
          label="Upload Lab Tests / MRL Reports"
          accept=".pdf,.png,.jpg"
          endpoint={endpoints.uploadWater()}
        />
        <FileUpload
          label="Upload HACCP/FSMA Plan"
          accept=".pdf"
          endpoint={endpoints.uploadWater()}
        />
      </div>

    ...
    <header style={{ background: "#fff", borderBottom: "1px solid #e4e7ec", padding: "0.5rem 0", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", gap: 16 }}>
        ...
        <nav style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          <NavLink to="/mortgage" className={linkClass}>Mortgage</NavLink>
          <NavLink to="/trade-finance" className={linkClass}>Trade Finance</NavLink>
          <NavLink to="/ag-market" className={linkClass}>Ag Marketplace</NavLink>
          <NavLink to="/tickers" className={linkClass}>Tickers</NavLink>

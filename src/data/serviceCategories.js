export const serviceCategories = [
  {
    ...
    modules: [
      ...
      {
        label: "Title Insurance Overcharge Review",
        to: "/audit/title-overcharge",
      },
    ],
  },
  {
    ...
    modules: [
      {
        label: "Credit Card Rate/Fee Compliance Review",
        to: "/audit/credit-card-fee",
      },
      { label: "NSF/Overdraft Fee Analysis", to: "/audit/nsf-overdraft" },
      {
        label: "Wire & Transfer Overcharge Review",
        to: "/audit/wire-transfer",
      },
      {
        label: "Account Maintenance Fee Review",
        to: "/audit/account-maintenance",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    modules: [
      ...
      {
        label: "Internet & Cell Phone Overcharges",
        to: "/audit/internet-cell",
      },
  ...
  },
  {
    ...
    modules: [
      ...
      {
        label: "Military & Veteran Financial Review",
        to: "/audit/military-veteran",
      },
    ],
  },
  {
    ...
    modules: [
      {
        label: "Unclaimed Property Search & Recovery",
        to: "/audit/unclaimed-property",
      },
    ],
  },
];

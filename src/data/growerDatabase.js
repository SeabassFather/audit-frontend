...
export const growerDatabase = [
  {
    ...
    bio: 'Leading Hass avocado producer in Michoacán with organic certification and modern processing facilities.'
  },
  {
    id: 'GRW-002',
  ...
  {
    id: 'GRW-005',
    companyName: 'Pimientos Jalapeños SA',
    dba: 'Jalapeño King',
    type: 'grower',
    location: {
      city: 'Delicias',
    ...
    commodities: ['Jalapeño Peppers', 'Bell Peppers', 'Serrano Peppers'],
    organic: false,
    certifications: ['globalgap', 'primusgfs', 'senasica'],

export const CATEGORIES = [
  {
    ...
    services: [
      ...
      { id: "CS008", name: "CFPB Complaint Trigger", desc: "Draft/submit; track responses." },
      { id: "CS009", name: "Military/Veteran Financial Review", desc: "SCRA protections, caps, refunds." },
      { id: "CS010", name: "Credit Report Clean-up", desc: "Dispute builder, validation letters." }
    ]
  },
  {
    key: "mortgage",
    ...
    services: [
      { id: "ML001", name: "Lender Match Engine", desc: "Purchase, Refi, Cash-Out, HELOC matching." },
      { id: "ML002", name: "Underwriting Prep", desc: "Checklist, TRID docs, conditions tracker." },
      { id: "ML003", name: "Rate/Lock Audit", desc: "Lock terms, extension fees, re-lock math." },
      { id: "ML004", name: "Loan Estimate / CD Review", desc: "Fee accuracy, tolerance cures, prorations." },
  ...
  },
  {
    ...
    services: [
      { id: "AG001", name: "Produce Market Explorer", desc: "Historical price trends; compare & export." },
      { id: "AG002", name: "USDA Pricing & Volume", desc: "Commodity drilldowns by market/variety/grade." },
      { id: "AG003", name: "Organic/Certification Lookup", desc: "USDA Organic, Primus, GlobalG.A.P." },
      { id: "AG004", name: "Factoring & PO Finance", desc: "Invoice factoring, advances, term sheets." },
      { id: "AG005", name: "Logistics & Cold Chain", desc: "Temp trace, chain-of-custody, claims." },
  ...
  },
  {
    ...
    services: [
      { id: "LG001", name: "Debt Validation Letters", desc: "FDCPA 809 demand set." },
      { id: "LG002", name: "UCC Demand/Notice Pack", desc: "State notices scaffold." },
  ...
  },
  {
    ...
    title: "Insurance",
    services: [
      { id: "IN001", name: "Premium Audit", desc: "Overcharge discovery & refunds." },
  ...
  },
  {
    ...
    services: [
      { id: "MD001", name: "Medical Billing Audit", desc: "CPT/ICD upcoding detection." },
      { id: "MD002", name: "Student Loan Analysis", desc: "Repayment fit, capitalization errors." }
    ]
  },
  {
    key: "biz",
    ...
    services: [
      { id: "BZ001", name: "Entity & License Checklist", desc: "Formation docs, licenses." },
      { id: "BZ002", name: "KYC/AML Pack", desc: "Policy templates, risk matrix." }
    ]
  },
  {
    key: "elite",

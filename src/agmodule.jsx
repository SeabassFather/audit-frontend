...
export default function AgModule() {
  ...
  return (
    <div className="p-4">
      <h2 className="h2">ðŸŒ¾ Agriculture Module</h2>
      <div className="grid">
        <div className="card">
          <div className="card-title">ðŸ’§ Water Management</div>
          <p className="subtext">
        ...
        <div className="card">
          <div className="card-title">ðŸ’µ Factoring</div>
          <p className="subtext">
        ...
        <div className="card">
          <div className="card-title">ðŸ“ˆ Produce Market Search</div>
          <input
            type="text"
            className="filter"

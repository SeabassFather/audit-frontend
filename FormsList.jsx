...
const forms = [
  { name: "Financial Audit Authorization", file: "/forms/financial_audit_authorization.txt" },
  { name: "Partner Onboarding & Eligibility", file: "/forms/partner_onboarding_eligibility.txt" },
  // Add more as needed
];

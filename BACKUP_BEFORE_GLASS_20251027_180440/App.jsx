...
function Navigation() {
  ...
  const tabs = [
    { path: '/', label: language === 'es' ? '📊 Panel' : '📊 Dashboard' },
    { path: '/dashboard', label: language === 'es' ? '🔬 Lab Dashboard' : '🔬 Lab Dashboard' },
    { path: '/results', label: language === 'es' ? '📋 Resultados' : '📋 Results' },
    { path: '/alcohol-analysis', label: '🧪 Alcohol' },
    { path: '/engine-performance', label: language === 'es' ? '🚜 Motor' : '🚜 Engine' },
    { path: '/environment-ai', label: language === 'es' ? '🌿 IA Ambiental' : '🌿 Environment AI' },
    { path: '/fuel-oil-analysis', label: language === 'es' ? '⛽ Combustible' : '⛽ Fuel/Oil' },
    { path: '/soil-analysis', label: language === 'es' ? '🌱 Suelo' : '🌱 Soil' },
    { path: '/testing-services', label: language === 'es' ? '🔬 Laboratorio' : '🔬 Testing' },
    { path: '/water-tech', label: language === 'es' ? '💧 Agua' : '💧 Water Tech' }
  ];
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '50px' }}>
          <h1 style={{
            ...
            🚀 {language === 'es' ? 'Plataforma Completa AuditDNA' : 'AuditDNA Complete Platform'}
          </h1>
          <p style={{ color: '#94a3b8', fontSize: '1.3rem' }}>
            {language === 'es' 
              ? 'Análisis profesional de agricultura y medio ambiente' 
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '25px', marginBottom: '25px' }}>
          <DashCard
            ...
            desc={language === 'es' ? 'Gestión de órdenes y resultados' : 'Manage orders and results'}
            color="#06b6d4"
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '25px', marginBottom: '25px' }}>
          <DashCard
            icon="🧪"
            title={language === 'es' ? 'Análisis de Alcohol' : 'Alcohol Analysis'}
          ...
          <DashCard
            ...
            desc={language === 'es' ? 'Diagnósticos' : 'Diagnostics'}
            color="#f97316"
          ...
          <DashCard
            ...
            desc={language === 'es' ? 'Análisis completo' : 'Complete analysis'}
            color="#10b981"
          ...
          <DashCard
            ...
            desc={language === 'es' ? 'Análisis de calidad' : 'Quality analysis'}
            color="#8b5cf6"
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '25px' }}>
          <DashCard
            icon="🌱"
            title={language === 'es' ? 'Análisis de Suelo' : 'Soil Analysis'}
          ...
          <DashCard
            ...
            desc={language === 'es' ? 'Órdenes de lab' : 'Lab orders'}
            color="#3b82f6"
          ...
          <DashCard
            ...
            desc={language === 'es' ? 'Próximamente' : 'Coming soon'}
            color="#64748b"
            onClick={() => alert('Coming soon!')}
          />
          <DashCard
            icon="💧"
            title={language === 'es' ? 'Análisis de Agua' : 'Water Analysis'}

    ...
    <div style={{padding: '40px', background: '#0f172a', minHeight: '100vh', color: 'white'}}>
      <div style={{maxWidth: '1600px', margin: '0 auto'}}>
        ...
        <div style={{background: '#1e293b', padding: '30px', borderRadius: '16px', border: '2px solid #334155', minHeight: '500px'}}>
          ...
          {activeTab === 'orders' && (
            <div>
              <h2 style={{color: '#06b6d4', marginBottom: '20px'}}>📋 Active Orders</h2>
              {loading ? (
          ...
          {activeTab === 'search' && (
            <div>
              <h2 style={{color: '#10b981', marginBottom: '20px'}}>🔍 Search Test Catalog</h2>
              ...
              <div style={{display: 'flex', gap: '10px', marginBottom: '20px', flexWrap: 'wrap'}}>
                {Object.keys(testCatalog).map(mod => (
                  <button key={mod} onClick={() => {setSelectedModule(mod); setSearchResults([]); setSearchQuery('');}} style={{padding: '10px 20px', background: selectedModule === mod ? '#10b981' : '#0f172a', border: `2px solid ${selectedModule === mod ? '#10b981' : '#334155'}`, borderRadius: '8px', color: selectedModule === mod ? 'white' : '#94a3b8', fontWeight: '700', cursor: 'pointer', textTransform: 'capitalize'}}>
                    {mod === 'water' && '💧'} {mod === 'soil' && '🌱'} {mod === 'alcohol' && '🧪'} {mod === 'fuel' && '⛽'} {mod === 'engine' && '🚜'} {mod}
                  </button>
                ))}
              </div>
              ...
              <div style={{display: 'flex', gap: '10px', marginBottom: '20px'}}>
                ...
                <button onClick={handleSearch} style={{padding: '14px 28px', background: 'linear-gradient(135deg, #10b981, #059669)', border: 'none', borderRadius: '8px', color: 'white', fontWeight: '700', cursor: 'pointer'}}>🔍 Search</button>
              </div>
          ...
          {activeTab === 'upload' && (
            <div>
              <h2 style={{color: '#f59e0b', marginBottom: '20px'}}>📤 Upload Reports & Data</h2>
              ...
              {uploadedFiles.length > 0 && (
                <div>
                  <h3 style={{color: '#10b981', marginBottom: '15px'}}>✅ Uploaded Files ({uploadedFiles.length})</h3>

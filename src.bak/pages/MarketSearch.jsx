  ...
  return (
    <div style={{ padding: "20px" }}>
      <h1 style={{ fontSize: 28, marginBottom: 12 }}>
        USDA Commodity Search & Pricing
      </h1>
      <p style={{ color: "#6b7280", marginBottom: 16 }}>
        Select commodities, set terms, and pull 26-week weekly averages. Flip to
        live AMS later without changing the UI.
      </p>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              placeholder="25 lb, 1L clamshell, 48ct…"
              style={{
                width: "100%",
                padding: "10px 12px",
                border: "1px solid #d1d5db",
          ...
          <div style={{ gridColumn: "span 2", fontSize: 12, color: "#6b7280" }}>
            Tip: when we flip LIVE_USDA=1, this chart reads AMS automatically.
          </div>
        </div>
      </div>

...
const AgMarket = () => {
  ...
  useEffect(() => {
    setNotice(
      USE_BACKEND
        ? ""
        : "Demo data active. Connect /api/market/avg to enable live USDA data.",
    );
  }, [year]);
  ...
  return (
    <div style={{ display: "grid", gap: 16 }}>
      ...
      >
        {notice && (
          <div style={{ color: "#ffce6b", marginBottom: 8 }}>{notice}</div>
        )}
  ...
  return (
    <header style={styles.header}>
      <div style={styles.brand}>
        {" "}
        <Shield size={18} /> <span>AuditDNA</span>
      </div>
...
const styles = {
  app: {
    minHeight: "100vh",
    background: "linear-gradient(180deg,#0b0f1a 0%,#0b0f1a 60%,#0d1220 100%)",
    color: "#e6e9ef",
    display: "grid",
  ...
  navBtnActive: {
    ...
    background: "#1a2240",
    borderColor: "#2f3d68",
    boxShadow: "0 1px 0 #2f3d68 inset",
  },

  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{display: 'flex', justifyContent: 'space-between', padding: '10px 0', borderBottom: '1px solid #334155'}}>
          <span style={{color: '#94a3b8'}}>File Processing ({uploadedFiles.length} files Ã— ${modulePrice.perFile})</span>
      ...
      <div style={{marginBottom: '25px'}}>
        ...
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '15px'}}>
          ...
          >
            <div style={{fontSize: '2rem', marginBottom: '10px'}}>ðŸ…¿ï¸</div>
      ...
      <div style={{
        ...
        <p style={{color: '#0ea5e9', fontSize: '0.95rem', lineHeight: '1.6'}}>
          ðŸ’¡ <strong>Billing Policy:</strong> You will only be charged after your files are successfully uploaded and processed. If you cancel or lose connection during upload, no charge will be made. A receipt will be emailed to {contactInfo?.email || 'your email address'} immediately after payment.
        </p>
      </div>
      ...
      >
        {processing ? 'â³ Processing Payment...' : `ðŸ’³ Pay $${total.toFixed(2)} Now`}
      </button>

      <p style={{color: '#64748b', fontSize: '0.85rem', textAlign: 'center', marginTop: '15px'}}>
        ðŸ”’ Secure payment processing. Your data is encrypted and never stored on our servers.
      </p>
    </div>
  );
}
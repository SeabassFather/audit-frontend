...
export default function FieldConditionsLogger({ 
  ...
  const handleSubmit = () => {
    ...
    if (sampleType === 'soil' && !conditions.soilTempSurface) {
      alert('Ã¢Å¡Â Ã¯Â¸Â Soil surface temperature required for soil samples!');
      return;
    }
    if (sampleType === 'water' && !conditions.waterTemp) {
      alert('Ã¢Å¡Â Ã¯Â¸Â Water temperature required for water samples!');
      return;
    }
    if (!conditions.airTemp || !conditions.humidity) {
      alert('Ã¢Å¡Â Ã¯Â¸Â Air temperature and humidity required!');
      return;
    }
    ...
    <div style={{
      ...
      <div style={{marginBottom: '25px'}}>
        <h2 style={{color: '#10b981', fontSize: '1.5rem', marginBottom: '10px'}}>
          Ã°Å¸Å’Â¡Ã¯Â¸Â Field Conditions at Time of Sample
        </h2>
      ...
      {sampleType === 'soil' && (
        <div style={{
          ...
          <h3 style={{color: '#fbbf24', fontSize: '1.2rem', marginBottom: '15px'}}>
            Ã°Å¸Å’Â± Soil Temperature Profile
          </h3>
      ...
      {sampleType === 'water' && (
        <div style={{
          ...
          <h3 style={{color: '#06b6d4', fontSize: '1.2rem', marginBottom: '15px'}}>
            Ã°Å¸â€™Â§ Water Sample Conditions
          </h3>
      ...
      <div style={{
        ...
        <h3 style={{color: '#10b981', fontSize: '1.2rem', marginBottom: '15px'}}>
          Ã°Å¸Å’Â¡Ã¯Â¸Â Air Temperature & Humidity
        </h3>
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '15px'}}>
          <div>
            <label style={{display: 'block', marginBottom: '5px', color: '#94a3b8', fontSize: '0.85rem'}}>
      ...
      <div style={{
        ...
        <h3 style={{color: '#8b5cf6', fontSize: '1.2rem', marginBottom: '15px'}}>
          Ã°Å¸â€œÅ  Barometric Pressure & Precipitation
        </h3>
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '15px'}}>
          <div>
            <label style={{display: 'block', marginBottom: '5px', color: '#94a3b8', fontSize: '0.85rem'}}>
          ...
          <div>
            ...
            >
              <option value="">Select...</option>
              <option value="rising">Rising Ã¢â€ â€”</option>
              <option value="steady">Steady Ã¢â€ â€™</option>
              <option value="falling">Falling Ã¢â€ Ëœ</option>
            </select>
          </div>
          <div>
            <label style={{display: 'block', marginBottom: '5px', color: '#94a3b8', fontSize: '0.85rem'}}>
      ...
      >
        Ã¢Å“â€¦ Save Field Conditions & Continue
      </button>
